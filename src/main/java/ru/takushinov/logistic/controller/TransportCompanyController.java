...
public class TransportCompanyController {
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')")
    @DeleteMapping
    public void delete(@RequestBody TransportCompanyDto transportCompanyDto) {
        transportCompanyService.delete(transportCompanyMapper.dtoToEntity(transportCompanyDto));
    }
}
